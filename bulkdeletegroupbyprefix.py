...
# A script which will bulk delete groups from NSX-T based on a prefix
# Note: Groups should not be used anywhere in NSX_T otherwise delete operation will fail 
